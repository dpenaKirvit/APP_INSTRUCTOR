...
namespace Electronica.Componentes
{
    public partial class VarBoard0x21
    {
        ...
        public VarBoard0x21()
        {
            ...
            solicitudEstado = Globales.ObtenerPeticion(CodigoBoard.Board0x21, TipoTrama.SolicitudEstado);
        ...
        public byte[] Escribir()
        {
            ...
            datos[1] = (byte)CodigoBoard.Board0x21;
        ...
        public bool PrenderCautionWarning()
        {
            return false;
        }
