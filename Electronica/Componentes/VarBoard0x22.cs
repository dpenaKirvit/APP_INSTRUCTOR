...
{
    public partial class VarBoard0x22
    {
        ...
        public VarBoard0x22()
        {
            ...
            solicitudEstado = Globales.ObtenerPeticion(CodigoBoard.Board0x22, TipoTrama.SolicitudEstado);
        ...
        public byte[] Escribir()
        {
            ...
            datos[1] = (byte)CodigoBoard.Board0x22;
        ...
        public bool PrenderMasterWarning()
        {
            return false;
        }
