...
{
    public partial class VarBoard0x25
    {
        ...
        public VarBoard0x25()
        {
            ...
            solicitudEstado = Globales.ObtenerPeticion(CodigoBoard.Board0x25, TipoTrama.SolicitudEstado);
        ...
        public byte[] Escribir()
        {
            ...
            datos[1] = (byte)CodigoBoard.Board0x25;
